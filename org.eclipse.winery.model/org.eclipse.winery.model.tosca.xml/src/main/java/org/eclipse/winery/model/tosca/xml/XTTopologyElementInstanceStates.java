...
public class XTTopologyElementInstanceStates implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof XTTopologyElementInstanceStates)) return false;
        XTTopologyElementInstanceStates that = (XTTopologyElementInstanceStates) o;
     ...
     * <p>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link XTTopologyElementInstanceStates.InstanceState }
     */
    @NonNull
    public List<XTTopologyElementInstanceStates.InstanceState> getInstanceState() {
        if (instanceState == null) {
            instanceState = new ArrayList<XTTopologyElementInstanceStates.InstanceState>();
        }
