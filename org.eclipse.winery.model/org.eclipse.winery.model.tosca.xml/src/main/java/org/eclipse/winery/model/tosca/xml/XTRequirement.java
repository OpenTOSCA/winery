...
public class XTRequirement extends XRelationshipSourceOrTarget {
    ...
    public boolean equals(Object o) {
        ...
        XTRequirement that = (XTRequirement) o;
    ...
    public static class Builder extends XRelationshipSourceOrTarget.Builder<Builder> {
        ...
        public XTRequirement build() {
            return new XTRequirement(this);
        }
    }
}
