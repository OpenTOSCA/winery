...
public class XOTStayMapping extends XOTPrmMapping {
    ...
    public XOTStayMapping(Builder builder) {
        super(builder);
    }

    @Override
    public boolean equals(Object obj) {
        return obj instanceof XOTStayMapping
            && getId().equals(((XOTStayMapping) obj).getId());
    }
    ...
    public static class Builder extends XOTPrmMapping.Builder<Builder> {
        ...
        public XOTStayMapping build() {
            return new XOTStayMapping(this);
        }
