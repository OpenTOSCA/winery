...
public class XTArtifact extends XTEntityTemplate {
    ...
    public static class Builder extends XTEntityTemplate.Builder<XTArtifact.Builder> {
        ...
        @Override
        public XTArtifact.Builder self() {
            return this;
        }

        public XTArtifact build() {
            return new XTArtifact(this);
        }
    }
}
