...
public class YTImportDefinition implements VisitorNode {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof YTImportDefinition)) return false;
        YTImportDefinition that = (YTImportDefinition) o;
    ...
    public static class Builder {
        ...
        public YTImportDefinition build() {
            return new YTImportDefinition(this);
        }
    }
}
