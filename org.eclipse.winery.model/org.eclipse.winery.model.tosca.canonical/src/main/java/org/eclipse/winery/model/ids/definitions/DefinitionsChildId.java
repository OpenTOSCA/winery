...
public abstract class DefinitionsChildId extends GenericId {
    ...
    public String toReadableString() {
        QName qn = this.getQName();
        String name = IdUtil.getEverythingBetweenTheLastDotAndBeforeId(this.getClass());
    ...
    public int compareTo(GenericId o1) {
        if (o1 instanceof DefinitionsChildId) {
            ...
            if (res == 0) {
                ...
                res = this.getNameWithoutVersion().compareTo(o.getNameWithoutVersion());
                if (res == 0) {
                    res = this.getVersion().compareTo(o.getVersion());
                }
                if (res == 0) {
    ...
    public String getNameWithoutVersion() {
        return VersionUtils.getNameWithoutVersion(getXmlId().getDecoded());
    }
