...
var artifact_component_1 = require("../../instance/sharedComponents/wineryArtifacts/artifact.component");
...
var toscaType = enums_1.ToscaTypes.RelationshipTypeImplementation;
var relationshipTypeImplementationRoutes = [
...
var RelationshipTypeImplementationRouterModule = (function () {
    function RelationshipTypeImplementationRouterModule() {
    }
    return RelationshipTypeImplementationRouterModule;
}());
RelationshipTypeImplementationRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(relationshipTypeImplementationRoutes),
        ],
        exports: [
...
exports.RelationshipTypeImplementationRouterModule = RelationshipTypeImplementationRouterModule;
//# sourceMappingURL=relationshipTypeImplementationRouter.module.js.map