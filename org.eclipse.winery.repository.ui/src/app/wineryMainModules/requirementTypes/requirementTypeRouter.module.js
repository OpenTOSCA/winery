...
var toscaType = enums_1.ToscaTypes.RequirementType;
var requirementTypeRoutes = [
...
var RequirementTypeRouterModule = (function () {
    function RequirementTypeRouterModule() {
    }
    return RequirementTypeRouterModule;
}());
RequirementTypeRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(requirementTypeRoutes),
        ],
        exports: [
...
exports.RequirementTypeRouterModule = RequirementTypeRouterModule;
//# sourceMappingURL=requirementTypeRouter.module.js.map