...
var toscaType = enums_1.ToscaTypes.ArtifactTemplate;
var artifactTemplateRoutes = [
    ...
    { path: toscaType + '/:namespace', component: section_component_1.SectionComponent, resolve: { resolveData: section_resolver_1.SectionResolver } },
    {
        ...
        children: [
            ...
            { path: 'source', component: artifactSource_component_1.ArtifactSourceComponent },
...
var ArtifactTemplateRouterModule = (function () {
    function ArtifactTemplateRouterModule() {
    }
    return ArtifactTemplateRouterModule;
}());
ArtifactTemplateRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(artifactTemplateRoutes),
        ],
        exports: [
...
exports.ArtifactTemplateRouterModule = ArtifactTemplateRouterModule;
//# sourceMappingURL=artifactTemplateRouter.module.js.map