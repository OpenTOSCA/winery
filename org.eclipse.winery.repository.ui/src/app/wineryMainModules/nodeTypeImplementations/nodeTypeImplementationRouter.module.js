...
var toscaType = enums_1.ToscaTypes.NodeTypeImplementation;
var nodeTypeImplementationRoutes = [
...
var NodeTypeImplementationRouterModule = (function () {
    function NodeTypeImplementationRouterModule() {
    }
    return NodeTypeImplementationRouterModule;
}());
NodeTypeImplementationRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(nodeTypeImplementationRoutes),
        ],
        exports: [
...
exports.NodeTypeImplementationRouterModule = NodeTypeImplementationRouterModule;
//# sourceMappingURL=nodeTypeImplementationRouter.module.js.map