...
var toscaType = enums_1.ToscaTypes.NodeType;
var nodeTypeRoutes = [
...
var NodeTypeRouterModule = (function () {
    function NodeTypeRouterModule() {
    }
    return NodeTypeRouterModule;
}());
NodeTypeRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(nodeTypeRoutes),
        ],
        exports: [
...
exports.NodeTypeRouterModule = NodeTypeRouterModule;
//# sourceMappingURL=nodeTypeRouter.module.js.map