...
var toscaType = enums_1.ToscaTypes.CapabilityType;
var capabilityTypeRoutes = [
...
var CapabilityTypeRouterModule = (function () {
    function CapabilityTypeRouterModule() {
    }
    return CapabilityTypeRouterModule;
}());
CapabilityTypeRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(capabilityTypeRoutes),
        ],
        exports: [
...
exports.CapabilityTypeRouterModule = CapabilityTypeRouterModule;
//# sourceMappingURL=capabilityTypeRouter.module.js.map