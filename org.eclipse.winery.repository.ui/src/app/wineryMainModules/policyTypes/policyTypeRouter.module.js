...
var toscaType = enums_1.ToscaTypes.PolicyType;
var policyTypeRoutes = [
...
var PolicyTypeRouterModule = (function () {
    function PolicyTypeRouterModule() {
    }
    return PolicyTypeRouterModule;
}());
PolicyTypeRouterModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(policyTypeRoutes),
        ],
        exports: [
...
exports.PolicyTypeRouterModule = PolicyTypeRouterModule;
//# sourceMappingURL=policyTypeRouter.module.js.map