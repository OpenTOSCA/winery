...
export declare const INITIAL_TOPOLOGY_RENDERER_STATE: TopologyRendererState;
/**
 * Reducer for the TopologyRenderer
 */
export declare const TopologyRendererReducer: (lastState: TopologyRendererState, action: Action) => TopologyRendererState;
