...
export class ReqCapRelationshipService {
    ...
    private sendSelectedRelationshipTypeEvent = new BehaviorSubject<any>('');
    ...
    passCurrentType(currentType: EntityType): void {
        this.sendSelectedRelationshipTypeEvent.next(currentType);
    }

    relationshipTypeEventListener() {
        return this.sendSelectedRelationshipTypeEvent.asObservable();
    }
